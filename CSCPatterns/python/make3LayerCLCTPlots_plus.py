...
print "test"
me11a_h = f.Get('h_clctLayerCount_me_p11a11')
me11b_h = f.Get('h_clctLayerCount_me_p11b11')

can = p.Canvas(True,lumi='')

me11a = p.Plot(me11a_h, legName='#splitline{#bf{ME+11A_11}}{Entries:%i}'%me11a_h.GetEntries(),legType = 'l',option='hist')
me11b = p.Plot(me11b_h, legName= '#splitline{#bf{ME+11B_11}}{Entries:%i}'%me11b_h.GetEntries(),legType = 'l',option='hist')
...
can.cleanup('ME11ab11_3layerCLCT_plus.pdf',mode='BOB')
