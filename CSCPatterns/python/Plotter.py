...
#         self.ratList.append(self.rat)
    ...
    def addRatioPlot(self,ratio, color=R.kBlack, legName='', legType='pe', option='hist', ytit='Data/MC', xtit='', zeroed=False, plusminus=0.5, yrange=[]):
        ...
        if len(yrange)==2:
            ...
            low=center-plusminus
            high = center+plusminus
        else:
            print 'you done effd up'
            exit()
        self.rat = ratio
    ...
    def addAndDivideRatioPlot(self, topPlot, bottomPlot, color=R.kBlack, legName='', legType='pe', option='hist', ytit='Data/MC', xtit='', zeroed=False, plusminus=0.5, yrange=[]):
        if self.ratioFactor == 0: return
        ...
        self.rat.Divide(bot)
        self.addRatioPlot(self.rat,color, legName, legType, option, ytit, xtit, zeroed, plusminus, yrange)
