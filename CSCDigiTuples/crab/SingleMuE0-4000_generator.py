...
# with command line options: SingleMuPt100_pythia8_cfi --fileout SingleMuonPt100.root --mc --eventcontent FEVTDEBUG --datatier GEN-SIM-RAW-RECO --conditions auto:mc --beamspot Realistic25ns13TeVEarly2017Collision -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco,RECO -n 64 --no_exec
# HAND EDITTED
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SingleMuPt100_pythia8_cfi nevts:64'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GenRawRecoE0-4000_MuonGun.root'),
...
process.generator = cms.EDProducer("FlatRandomEGunProducer",
    ...
    psethack = cms.string('single mu e 0-4000')
)
